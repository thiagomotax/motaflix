...
public class FormUser extends javax.swing.JPanel {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (this.fieldName.getText().isEmpty() || this.fieldCPF.getText().isEmpty() || this.fieldDate.getText().isEmpty() || this.fieldEmail.getText().isEmpty() || this.fieldPassword.getText().isEmpty() || value == 0) {
            ...
            try {
                editUser(this.fieldName.getText(), this.fieldCPF.getText(), this.fieldDate.getText(), this.fieldEmail.getText(), this.fieldPassword.getText());
            } catch (SQLException ex) {
                Logger.getLogger(FormUser.class.getName()).log(Level.SEVERE, null, ex);
            } catch (ParseException ex) {
                Logger.getLogger(FormUser.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void addUser(String name, String cpf, String birthday, String email, String password) throws SQLException, ParseException {
        ...
        int insertedId = controller.save(0, name, cpf, birthday, email, password, value);

        //updatel local
        model.addRow(new Object[]{insertedId, name, cpf, birthday, email, password});
    }

    public void editUser(String name, String cpf, String birthday, String email, String password) throws SQLException, ParseException {
        ...
        this.table.setValueAt(cpf, row, 2);
        this.table.setValueAt(birthday, row, 3);
        this.table.setValueAt(email, row, 4);
        this.table.setValueAt(password, row, 5);
