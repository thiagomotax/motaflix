...
public class FormCategory extends javax.swing.JPanel {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (this.fieldName.getText().isEmpty()) {
            ...
            try {
                addCategory(this.fieldName.getText());
    ...
    public void addCategory(String name) throws SQLException, ParseException {
        DefaultTableModel model = (DefaultTableModel) this.table.getModel();

        //update remote
        CategoryController controller = new CategoryController();
        int insertedId = controller.save(0, name);

        //update local
        model.addRow(new Object[]{insertedId, name});
    }

    public void editCategory(String name) throws SQLException, ParseException {
        //update remote
        CategoryController controller = new CategoryController();
        controller.save((int) this.table.getModel().getValueAt(row, 0), name);
